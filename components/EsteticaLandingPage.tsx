                        ...
                        <div className="hidden lg:block relative">
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { img: '/studio-styles/maquiadora.png', label: 'Maquiadora' },
                                    { img: '/studio-styles/insp_golden_hour.png', label: 'Golden Hour' },
                                    { img: '/studio-styles/insp_editorial_elegante.png', label: 'Editorial' },
                                ].map((s, i) => (
                        ...
                        <div className="lg:hidden -mx-6 px-6">
                            <div className="flex gap-3 overflow-x-auto pb-4 scrollbar-hide">
                                {[
                                    ...
                                    { img: '/studio-styles/insp_golden_hour.png', label: 'Golden Hour' },
                                    { img: '/studio-styles/insp_editorial_elegante.png', label: 'Editorial' },
                                    { img: '/studio-styles/insp_luz_natural.png', label: 'Luz Natural' },
                                ].map((s, i) => (
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        {[
                            ...
                            { img: '/studio-styles/insp_power_portrait.png', label: 'Influencer Beauty', desc: 'Power portrait impactante' },
                        ].map((style, i) => (
            ...
            <section className="py-24 bg-[#050505] border-t border-white/5 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-5 gap-2 mb-8">
                        {[
                            { img: '/studio-styles/glow_beauty.png', label: 'Glow' },
                            { img: '/studio-styles/maquiadora.png', label: 'Make' },
                            { img: '/studio-styles/insp_golden_hour.png', label: 'Golden' },
                            { img: '/studio-styles/insp_editorial_elegante.png', label: 'Editorial' },
                            { img: '/studio-styles/insp_luz_natural.png', label: 'Natural' },
                        ].map((s, i) => (
